 ...
 */
public class RemoveFolder extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        messageLabel.setText("移动整个文件夹系列");
...
private void copyButtonActionPerformed(java.awt.event.ActionEvent evt) {
	...
	String strPathSave = pathTextField1.getText();
	if(strPath.equals("") ||strPathSave.equals("")){
		JOptionPane.showMessageDialog(this, "请输入完整的文件地址","信息对话框",JOptionPane.WARNING_MESSAGE);
		return;
	}
...
public void run() {	
	...
	fileHeald.copyFolder(pathTextField.getText(), pathTextField1.getText()+"\\"+folderStr);
	fileHeald.deleteDirs(new File(pathTextField.getText()));
	removeMessage.setVisible(false);
	int t = JOptionPane.showConfirmDialog(this, "移动完毕，需要继续吗?", "确认对话", JOptionPane.YES_NO_OPTION);
